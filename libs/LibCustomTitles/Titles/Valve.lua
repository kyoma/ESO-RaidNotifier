...
MY_MODULE:RegisterTitle("@Nafirian",		nil,	   705, 	{en = "Grand Over-Princess", 			de = "Großprinzessin",	 				fr = "la plus grande des princesses"	})
MY_MODULE:RegisterTitle("@Nafirian",		nil,	  1330, 	{en = "Princess Guar", 					de = "Guarprinzessin", 					fr = "Princesse Guar"					})
MY_MODULE:RegisterTitle("@Jonny94ESO",		nil,	  1391, 	{en = "Papa Guar" 																										})
