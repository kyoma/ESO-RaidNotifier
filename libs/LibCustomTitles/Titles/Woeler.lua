...
MY_MODULE:RegisterTitle("@Woeler",        nil, 1391, {en = "The Almighty God", de = "Der allmächtige Gott"})
MY_MODULE:RegisterTitle("@Woeler",        nil, 1810, {en = "The Almighty God", de = "Der allmächtige Gott"})
...
MY_MODULE:RegisterTitle("@DeCarn",        nil, 1391, {en = "Nerevarine"})
