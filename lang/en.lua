...
L.Settings_Sunspire_Chilling_Comet_TT   = "Alerts you when Chilling Comet debuff is applied to you that needs to be blocked and not overlapped with another player who has the same debuff before explosion."
L.Settings_Sunspire_Sweeping_Breath		= "Nahvinaas: Sweeping Breath"
L.Settings_Sunspire_Sweeping_Breath_TT  = ""
L.Settings_Sunspire_Molten_Meteor		= "Nahvinaas: Molten Meteor"
L.Settings_Sunspire_Molten_Meteor_TT    = "Targeted meteor on three players who should move their meteors away from the group."
L.Settings_Sunspire_Focus_Fire			= "Yolnukrinn: Focus Fire"
L.Settings_Sunspire_Focus_Fire_TT		= "Alerts when you or any of your team members have the Focus Fire debuff that requires group to stack to negate this debuff. Require two separate groups because of debuff time."
L.Settings_Sunspire_Breath              = "General: Fire/Frost/Searing Breath"
L.Settings_Sunspire_Breath_TT			= "Alerts you when channeled cone from boss is on you."
L.Settings_Sunspire_Cataclism			= "Yolnukrinn: Cataclism"
L.Settings_Sunspire_Cataclism_TT		= "The fire in the middle of the arena, when everyone have to go to the corner."
L.Settings_Sunspire_Frozen_Tomb			= "Lokkestiiz: Frozen Tomb"
L.Settings_Sunspire_Frozen_Tomb_TT		= "The fire in the middle, when everyone have to go to the edge of the arena."
L.Settings_Sunspire_Trash               = "Nahvinaas: Thrash"
L.Settings_Sunspire_Trash_TT			= "Alerts you when boss is about to thrash his head and knock back melee range players."
L.Settings_Sunspire_Mark_For_Death		= "Nahvinaas: Mark For Death"
L.Settings_Sunspire_Mark_For_Death_TT   = "This is a tank swap mechanic on last boss."
...
L.Alerts_Sunspire_Trash                 = "Incoming |cff0000Thrash|r! Block!"
